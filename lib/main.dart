...
import 'package:sqflite_flutter/models/todo.dart';
import 'package:sqflite_flutter/repository/database_creator.dart';
import 'package:sqflite_flutter/repository/repository_service_todo.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: SqfLiteCrud(title: 'SQLite - Tiu'),
    );
  }
}
